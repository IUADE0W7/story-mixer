const en = {
  vibe: {
    ...
    seeds: {
      ...
      loneWandererSeed: "A lone wanderer arrives at the edge of a dying world with no name and nothing to lose.",
      darkProphecySeed: "A prophecy demands a sacrifice no hero is willing to make — and the clock has already started.",
      hiddenMonsterSeed: "The monster they feared was never the beast. It was the ally who smiled at the threshold.",
      unlikelyAlliesSeed: "Two sworn enemies, bound by necessity, must trust each other with the one thing neither can afford to lose.",
      forbiddenArchiveSeed: "A sealed archive holds the one truth that could unravel the empire — and someone already knows it.",
      lastBloodlineSeed: "The last heir of an ancient bloodline carries a power they cannot control and a price they cannot pay.",
      theBetraySeed: "A trusted figure betrays them in the final hour. They had good reason. That makes it worse.",
      shatteredCitySeed: "A once-great city lies in ruins. Someone is rebuilding it — not to restore what was lost, but to erase it.",
    },
    fields: {
      genre: "Genre",
      chapters: "Chapters",
