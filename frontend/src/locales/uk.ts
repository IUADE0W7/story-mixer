...
const uk: typeof en = {
  vibe: {
    ...
    seeds: {
      ...
      loneWandererSeed: "Самотній мандрівник прибуває на край вмираючого світу — без імені та без нічого, що варто було б тримати.",
      darkProphecySeed: "Пророцтво вимагає жертви, на яку жоден герой не готовий — і відлік уже почався.",
      hiddenMonsterSeed: "Чудовисько, якого вони боялися, ніколи не було звіром. Це був союзник, який посміхався на порозі.",
      unlikelyAlliesSeed: "Двоє заклятих ворогів, пов'язаних необхідністю, мусять довіритися один одному в тому, що жоден не може собі дозволити втратити.",
      forbiddenArchiveSeed: "Запечатаний архів зберігає єдину правду, здатну зруйнувати імперію — і хтось вже знає її.",
      lastBloodlineSeed: "Останній спадкоємець стародавнього роду несе силу, якою не може керувати, та ціну, якої не може заплатити.",
      theBetraySeed: "Довірена особа зраджує їх в останню мить. У неї були вагомі причини. Від цього стає ще гірше.",
      shatteredCitySeed: "Колись велике місто лежить у руїнах. Хтось його відбудовує — не щоб відновити втрачене, а щоб стерти його.",
    },
    fields: {
      genre: "Жанр",
      chapters: "Розділи",
    ...
    genres: {
      ...
      romance: "Романс",
      thriller: "Трилер",
      historicalFiction: "Історична проза",
      fairyTale: "Казка",
      mystery: "Детектив",
      adventure: "Пригоди",
      mythology: "Міфологія",
      speculativeFiction: "Спекулятивна фантастика",
    },
    placeholders: {
